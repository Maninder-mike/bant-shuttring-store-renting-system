...
"""
Script for running BSSRS tests programmatically.
"""
# TODO Correct Runtest file for tests
...
def main():
    """Parse args then run the pytest suite for BSSRS."""
    test_parser = argparse.ArgumentParser(
        usage='python runtests.py [-h] [--run-slow] [pytest_args]',
        description="Helper script to run BSSRS's test suite")
